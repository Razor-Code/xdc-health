const Sidelinks = (props) => {
    return (
        <a className={props.current ? "flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-md mt-5" : "flex items-center px-4 py-2 mt-5 text-gray-200 transition-colors duration-300 transform rounded-md hover:bg-white hover:bg-opacity-30 hover:text-gray-700"} href="#">
  ...
  return (
    <div className="flex flex-col w-64 h-screen px-4 py-8 absolute top-0 left-0 border-r bg-teal-700">
        ...
        <div className="flex flex-col justify-between flex-1 mt-3">
            <nav>
                <Sidelinks name="Dashboard" image="/assets/dashboard.png" current={props.page == "dashboard" ? true : false} />
                <Sidelinks name="Profile" image="/assets/profile.png" current={props.page == "profile" ? true : false} />
                <Sidelinks name="Appointments" image="/assets/appointment.png" current={props.page == "appoinments" ? true : false} />   
                <Sidelinks name="Documents" image="/assets/document.png" current={props.page == "documents" ? true : false} />
            </nav>
