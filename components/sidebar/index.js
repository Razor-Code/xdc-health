export default function Sidebar({visible}) {
  return (
    <div className={`${visible === 'yes' ? 'block ' : 'hidden '} flex flex-col w-full md:w-64 h-screen px-4 py-8 bg-white fixed dark:bg-gray-900`}>
      <h2 className="text-3xl font-semibold text-gray-800 dark:text-white">XDC Health</h2>
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
          ...
          <div className="flex items-center px-4 -mx-2">
              ...
              <h4 className="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Org Admin</h4>
          </div>
      </div>
  </div>
  )
